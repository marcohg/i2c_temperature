...
void lpi2c_master_callback(LPI2C_Type *base, lpi2c_master_handle_t *handle,
...
int i2c_test() {
  ...
  LPI2C_MasterTransferCreateHandle(EXAMPLE_I2C_MASTER, &g_m_handle,
  ...
  reVal = LPI2C_MasterTransferNonBlocking(EXAMPLE_I2C_MASTER, &g_m_handle,
                                          &masterXfer);
